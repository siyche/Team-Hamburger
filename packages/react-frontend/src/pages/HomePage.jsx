            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        Built for students, organizers, and planners — The Hamburger Calendar streamlines your scheduling needs. Create events and tasks, track academic and personal obligations, and select custom themes. Designed by a Cal Poly student team to help you manage your life effortlessly.
                        </p>
